...
void evFinger(int action, int fingerID, float x, float y, float z){}
void evQuit(){}
void evKey(int action, int key){}
void evMouse(int action, int button, int x, int y){}
void evInput(const std::string &str){}
void evWindowResize(int w, int h){}
